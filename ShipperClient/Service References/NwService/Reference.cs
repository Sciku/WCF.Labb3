...
namespace ShipperClient.NwService {
    ...
    public interface IShipperService {
        ...
        ShipperClient.NwService.Shipper GetShipperByID(int ShipperID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IShipperService/GetShipperByID", ReplyAction="http://tempuri.org/IShipperService/GetShipperByIDResponse")]
        System.Threading.Tasks.Task<ShipperClient.NwService.Shipper> GetShipperByIDAsync(int ShipperID);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IShipperService/SaveShipper", ReplyAction="http://tempuri.org/IShipperService/SaveShipperResponse")]
        System.Threading.Tasks.Task<int> SaveShipperAsync(int ShipperID, string CompanyName, string Phone);
    }
    ...
    public partial class ShipperServiceClient : System.ServiceModel.ClientBase<ShipperClient.NwService.IShipperService>, ShipperClient.NwService.IShipperService {
        ...
        public ShipperClient.NwService.Shipper GetShipperByID(int ShipperID) {
            return base.Channel.GetShipperByID(ShipperID);
        }
        
        public System.Threading.Tasks.Task<ShipperClient.NwService.Shipper> GetShipperByIDAsync(int ShipperID) {
            return base.Channel.GetShipperByIDAsync(ShipperID);
        }
        
        public int SaveShipper(int ShipperID, string CompanyName, string Phone) {
            return base.Channel.SaveShipper(ShipperID, CompanyName, Phone);
        }
        
        public System.Threading.Tasks.Task<int> SaveShipperAsync(int ShipperID, string CompanyName, string Phone) {
            return base.Channel.SaveShipperAsync(ShipperID, CompanyName, Phone);
        }
    }
}
